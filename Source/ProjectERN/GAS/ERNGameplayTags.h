...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_State_Combat_UsingSkill)
...
// 자원 관련 (Data는 BP에서 적용한 수치를 GE에 전달하기 위한 태그)
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Data_Heal_Amount)			// 체력 회복량
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_GameplayCue_Ultimate_Mage_Cast)					// 마법사 궁극기 사용 시 GC
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_GameplayCue_Ultimate_Mage_Explosion)				// 마법사 궁극기 폭발 GC
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_GameplayCue_Ultimate_Sanctuary_Cast)				// 성기사 궁극기 사용 시 GC
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_GameplayCue_Ultimate_Sanctuary_Field)			// 성기사 궁극기 폭발 GC

// 이벤트
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Event_Consumable_Throw)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Event_Movement_JumpLaunch)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Event_WeaponSkill_Instant_Projectile)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Event_WeaponSkill_Instant_Explosion)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Event_Skill_Ultimate_Explosion)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Event_Skill_Normal_PaladinShield_Apply)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Event_Skill_Ultimate_Sanctuary_SpawnAoE)
