...
<strong>ProjectERN (Ashen Oath)</strong>은 엘든 링 밤의 통치자을 레퍼런스로 제작한 **3인 협동 소울라이크 액션 RPG**입니다.

플레이어는 제한된 시간 동안 월드를 탐험하며 장비와 아이템을 획득하고, 성장한 뒤 보스를 공략하는 게임 루프를 기반으로 합니다. 또한 검은비(자기장) 시스템과 인스턴스 던전을 추가하여 **협동 플레이 중심의 게임 경험을 구현**했습니다.
